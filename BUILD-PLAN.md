...
- ⬜ No GitHub remote yet (will be private at creation) — the scaffold commit is local
...
[~] CI gates pass locally (lint · typecheck · test · secret-scan); CI goes green on first push to GitHub
