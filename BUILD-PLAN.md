...
Sequence: **A → B → C → D** (Melroy's pick; ascending effort, quick wins first). ✅ **A, B, and C shipped 2026-06-22.** **D (Routines) is next.** The rest (custom lists, cumulative counts, deeper low-stim) later.
