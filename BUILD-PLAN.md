...
Sequence: **A → B → C → D** (Melroy's pick; ascending effort, quick wins first). ✅ **A and B shipped 2026-06-22.** **C is next** (low-capacity day mode + wind-down nudge), then **D** (Routines). The rest (custom lists, cumulative counts, deeper low-stim) later.
