...
**Status (2026-07-24): in review on both stores; web is live with real paying Stripe subscribers.**
- **Web:** live at [doubledone.app](https://doubledone.app), auto-deployed from `main`, carrying everything through the Apple IAP wave.
- **iOS:** v1.0 (build 10) + both subscriptions **submitted to App Review 2026-07-19**, Waiting for Review, manual release selected. Apple IAP, the RevenueCat webhook, and the App-Review sign-in relay are all live and device-proven (a real sandbox purchase, cancellation, and the entitlement chain all verified).
- **Android:** versionCode 11 has been in **closed testing** since 2026-07-12 (git tag `android-v11`, commit d983bbf). **Production access applied for 2026-07-23** (the 12-testers-for-14-days gate for new personal accounts); the v12 production AAB is building, ready to upload the moment access is granted. It carries the held-card gesture, the trial-conversion and dunning money-path fixes, the corrected in-app legal text, and the comp fix.
