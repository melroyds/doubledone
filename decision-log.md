...
**Signage (2026-06-20).** Premium status shows as a calm "Active ✓" badge on the Settings → DoubleDone Premium row (entitlement loaded on focus) and the "You're Premium ✓" panel on `/premium`. Kept deliberately quiet, no badge on Today or the Lookback, to honour the calm, never-gaudy spine; the right amount of acknowledgement without turning status into decoration.
