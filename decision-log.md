...
12 client + 5 server tests, 561/425 green. Verified in the preview by forcing the states (the chips tint and clear correctly, the end arrows dim, the edit controls render per row); the AI round trip itself is not exercised on web. E2E SEQ-05 and SEQ-06.
