...
- **Value.** The first to-do app built *around* the ADHD / AuDHD / OCD failure modes rather than retrofitted onto a neurotypical optimiser, and it now goes deep on each, including the OCD side most apps ignore. Founder-market-fit plus a never-shame architecture the incumbents cannot copy without rebuilding their core.
...
**The answer.** DoubleDone is built around those failure modes, and has now gone deep on each rather than wide on new ones:
...
- **The OCD and perfectionism overlap:** **"Done is done"** and **"Good enough"**, the first features aimed squarely at that side of the audience.
