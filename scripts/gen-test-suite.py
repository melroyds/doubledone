...
CASES = [
    ...
    ("UPD-02", "Updates", "P1", "Web offers a reload, and says drafts are kept",
     "With the Worker's LATEST_WEB set ahead of the running build, open Settings on the web.",
    ...
    ("UPD-03", "Updates", "P1", "Native points at the store, and says lists are untouched",
     "With LATEST_IOS / LATEST_ANDROID set ahead of the installed build, open Settings on a device.",
    ...
    ("UPD-04", "Updates", "P2", "Unreachable server says NOTHING, never 'up to date'",
     "Put the device in aeroplane mode and open Settings.",
