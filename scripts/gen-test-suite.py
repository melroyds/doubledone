...
CASES = [
    ...
    ("AUD-06", "Audit fixes", "P3", "The polish batch",
     ...
     "No Premium pill on Chart a course for a subscriber. Dusk is never announced as Premium and tapping it as a free user selects it rather than bouncing. The signed-out paywall shows the Monthly / Annual toggle and both prices (checkout still needs sign-in). The edit-repeat button reads 'Save · Every Mon', with a verb. An empty day's note and '+ I also did that' sit above the dock, not under it. Spoken labels say '1 quieter action' and 'Removes 1 task'. Removing a rhythm says 'Rhythm removed.' and its name field is labelled 'Rhythm name'. The onboarding reveal rows show a small dot, not a tick-box replica. The 'big' chip stays visible in select mode. Focus with one open task opens straight on it, no 'Which one?'.", "Both"),
