...
CASES = [
    ...
    ("LB-10", "Lookback", "P2", "Repeating tasks project onto the calendar ('hair washing day')",
     "Create a repeating task with an interval (e.g. 'Wash hair' every 4 days) and a daily one. Open the Lookback and look at the days ahead. Tap a future day that carries the planned dot. Then skip-today one occurrence (hold the task on Today on its due day, Remove) and re-check that day in the calendar.",
