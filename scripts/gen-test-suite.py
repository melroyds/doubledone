...
CASES = [
    ...
    ("OUR-114", "Ours", "P2", "The day zone changes its question when a rhythm is alive",
     "In the room, hold a row and open When…. With no rhythm selected, read the label above the day chips. Now tap Daily. Read it again.",
     "It reads 'A day' with no rhythm, and relabels to 'Starting' the moment one is selected, in the accent colour. The same chips now mean 'from when' rather than 'which day'. Anytime disappears while a rhythm runs, because a rhythm has no anytime. Tap the selected rhythm chip again and it releases: the label goes back to 'A day' and the summary says 'The rhythm ends.' before anything commits.", "Both"),
