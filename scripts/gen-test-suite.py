...
CASES = [
    ...
    ("NRG-01", "Energy", "P1", "What fits right now: one question, one pick, propose-only",
     "With AI on and 2+ open one-off tasks, tap 'Focus on one thing'; in the 'Which one?' picker, 'What fits right now?' sits above the task choices (it lives INSIDE Focus, not as a standalone Today button). Tap it, pick an energy level (Running low / Somewhere in between / Feeling good). Then tap 'Start with this'; separately try 'Not now'.",
