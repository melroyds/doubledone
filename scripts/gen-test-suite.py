...
CASES = [
    ...
    ("TOD-04", "Today", "P1", "Close the day -> rested state",
     "Tap 'Close the day', read the wrap, then tap 'Goodnight'.",
     "Wrap celebrates what you finished (zero guilt, unfinished never shamed). After Goodnight, Today becomes a calm 'You've closed today' rested screen with the task list + capture hidden. Survives reload.", "Both"),
