...
CASES = [
    ...
    ("TOD-17", "Today", "P2", "Bring a Later task forward to today",
     "Schedule a task for a future day (capture with 'Date...', or push one to Tomorrow) so it sits in the 'Later' list. Tap the 'Bring to today' link under it.",
     "The task moves out of Later and into Today immediately (its due becomes today). The link disappears once it is in Today. No shame framing, just a quiet pull-forward, the mirror of pushing to tomorrow.", "Both"),
