...
CASES = [
    ...
    ("HLD-01", "Hold me to it", "P1", "A held task keeps knocking until it is done",
     "On a phone, hold a task, open the fold (Steps / Remind me / ...), tap 'Hold me to it'. Note the affirm. Leave the app closed and watch notifications arrive at ~30m, ~90m, ~3h, ~6h. Read each notification's wording. Next morning check ~09:30.",
