...
const makeStyles = (t: Theme) =>
  StyleSheet.create({
    ...
    lookbackLink: { color: t.colors.accent, fontSize: 15 * t.scale, fontWeight: '600', fontFamily: fonts.body },
    ...
    closeDayText: { color: t.colors.inkSoft, fontSize: 15 * t.scale, fontWeight: '600', fontFamily: fonts.body },
    ...
    strategiseBtnText: { color: t.colors.accent, fontSize: 16 * t.scale, fontWeight: '600', fontFamily: fonts.body },
    ...
    planWhen: { color: t.colors.accent, fontSize: 14 * t.scale, fontWeight: '600', fontFamily: fonts.body },
    ...
    wrapCheck: { color: t.colors.done, fontSize: 16 * t.scale, fontWeight: '700', fontFamily: fonts.body },
    ...
    wrapBtnText: { color: '#FFFFFF', fontSize: 16 * t.scale, fontWeight: '600', fontFamily: fonts.body },
  });
