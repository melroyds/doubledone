...
const makeStyles = (t: Theme) =>
  StyleSheet.create({
    ...
    stepBoxDone: { backgroundColor: t.colors.accent, borderColor: t.colors.accent },
    stepTick: { color: t.colors.onAccent, fontSize: 14 * t.scale, fontFamily: fonts.bodyBold },
    stepTitle: { color: t.colors.ink, fontSize: 16 * t.scale, fontFamily: fonts.body, flex: 1 },
    stepTitleDone: { color: t.colors.inkSoft },
