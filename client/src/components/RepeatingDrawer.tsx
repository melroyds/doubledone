...
const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  boxDone: { backgroundColor: t.colors.accentSoft, borderColor: t.colors.accent },
  tick: { color: t.colors.accent, fontSize: 14 * t.scale, fontWeight: '700', fontFamily: fonts.bodyBold },
